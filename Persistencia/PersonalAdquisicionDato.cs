...
{
    internal class PersonalAdquisicionesDatos : Entity<String>
    {
        ...
        public PersonalAdquisicionesDatos(String idTrabajador, String nombre, String password, String tipoTrabajador, int idAdquisiciones)
            : base(idTrabajador)
        {
            this.nombre = nombre;
